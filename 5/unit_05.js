...
function t6() {
    let res = '';
    let count = Number(document.querySelector('.i-6').value);
...
function t7() {
    let i7 = Number(document.querySelector('.i-7').value);
    let res = '';
    for (let i = i7; i >= 0; i--) {
        res += i + '_';
    }
...
function t8() {
    let i81 = Number(document.querySelector('.i-81').value);
    let i82 = Number(document.querySelector('.i-82').value);
    let res = '';
...
function t9() {
    let i91 = Number(document.querySelector('.i-91').value);
    let i92 = Number(document.querySelector('.i-92').value);
    let res = '';

    for (let i = Math.min(i91, i92); i <= Math.max(i91, i92); i++) {
        res += i + '_';
    }
...
function t14() {
    let divs14 = document.getElementsByClassName('i-14');
    for (let i = 0; i < divs14.length; i++) {
        if (divs14[i].checked) {
            document.querySelector('.out-14').textContent = divs14[i].value;
            break;
        }
    }
}
