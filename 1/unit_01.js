// Ссылка на урок: https://itgid.info/unit/javascript-2?unit=first-program
...
document.getElementById('seven').textContent = String(12 * 12);
...
// Task 9.
document.querySelector('h2 .out-8').textContent = 'world';
...
let z1 = 6;
let z2 = 3;
document.querySelector('.out-14').textContent = String(z1 * z2);
...
let y1 = 6;
let y2 = 3;
document.querySelector('.out-15').textContent = String(y1 / y2);
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.out-16').textContent = x1 + String(x2);
