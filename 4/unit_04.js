// Ссылка на урок: https://itgid.info/unit/javascript-2?unit=form-in-javascript
...
function f4() {
    document.querySelector('.out-4').textContent = i4.checked;
}
...
function f5() {
    document.querySelector('.out-5').textContent = (i5.checked) ? i5.value : false;
}
...
function f7() {
    ...
    document.querySelector('.out-72').textContent = Number(i7.value.length >= 6);
}
...
function f9() {
    document.querySelector('.out-9').textContent = (r9.checked) ? r9.value : false;
}
...
function f10() {
    document.querySelector('.out-10').style.background = i10.value;
}
...
function f15() {
    document.querySelector('.t-15').textContent = i15.value;
    document.querySelector('.out-15').textContent = i15.value;
}
