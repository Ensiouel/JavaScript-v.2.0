// Ссылка на урок: https://itgid.info/unit/javascript-2?unit=out-data
...
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1; //f1 преобразуется в строку и происходит конкатенация строк.
...
document.querySelector('.b-10').onclick = function() { 
    document.querySelector('.out-10').textContent = document.querySelector('.i-10').value * 20;
};
...
document.querySelector('.b-12').onclick = function() { 
    let v1 = document.querySelector('.i-12-1').value;
    let v2 = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').textContent = `Hello ${v1} ${v2}`;
};
...
document.querySelector('.b-16').onclick = function() { 
    let v1 = Number(document.querySelector('.i-16-1').value);
    let v2 = Number(document.querySelector('.i-16-2').value);
    document.querySelector('.out-16').textContent = v1 + v2;
};
...
// Task 18.
//  По нажатию на Doge .b-18 выполняется функция t18. Функция получает из .i-18 число в переменную a. Выводит в out-18 результат операции parseFloat(a). Попробуйте ввести значения 5, 33.02, 33.9a, -20.01
